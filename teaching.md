...
<ul class="tabs">
    <li>
        <a href="#t1">Teaching Philosophy</a></li>
    <li>
        <a href="#t2">Showcase of Teaching</a></li>
      <li>
        <a href="#t3">Annotated Bibliography</a></li>
</ul>
</div>
...
<div class="clear">
<h2><span id="t1"></span><a href="#t1"><i class="fa fa-chevron-up"></i></a>Teaching Philosophy</h2>
    ...
    <div class="column-last column-bottom clear">
        <h3>Principle 1: Meaning making and transfer of learning happen within and beyond the classroom.</h3>
            ...
            <em> as part of EDUC 8215 - TESOL Practice Teaching Assignment</em>
                <h5>Content</h5>
                    <p>Future 4 English for Work, Life, and Academic Success. Curtis et al. 2019. <em>Future 4: English for Work Life, and Academic Success.</em> Pearson Education.</p>
                <h5>USCIS - Citizenship test (2020)</h5>
                    <a href="https://www.uscis.gov/citizenship-resource-center/civics-test-2020-version/study-for-the-test-2020-version">USCIS Self Study Guide</a>
                <h5>Grammar books - Betty Azar</h5>
                    <li>
                    <a href="#">Azar, B. S. (2003). Fundamentals of English grammar. Longman</a></li>
                    <li>
                    <a href="#">Azar, B. S. (1996). Basic english grammar. Prentice Hall Regents.</a></li>
                    <li>
                    <a href="#">Azar, B. S. (2002). Understanding and using english grammar 3rd edition with answer key.</a></li>
                <h5>Corpus Resources</h5>
                    <li>
                    <a href="https://www.english-corpora.org/coca/">The Corpus of Contemporary American English (COCA)</a></li>
                    <li>
                    <a href="https://www.linguistics.ucsb.edu/research/santa-barbara-corpus">The Santa Barbara Corpus of Spoken American English</a></li>
                <h5>Digital Tools for Learning</h5>
                    <li>
                    <a href="https://quizlet.com/">Quizzlet</a></li>
                    <li>
                    <a href="https://quizizz.com/">Quizizz</a></li>
                    <li>
